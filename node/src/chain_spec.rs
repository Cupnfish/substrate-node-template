use node_template_runtime::{
	...
	SystemConfig, WASM_BINARY, PnsNftConfig, PnsRegistryConfig, PnsRegistrarConfig, PnsRedeemCodeConfig, PnsPriceOracleConfig, PnsResolversConfig, PnsOriginConfig,
};
